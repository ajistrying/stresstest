...
<template>
  <div>
    <header class="bg-white dark:bg-black_alt">
      <nav
      ...
      >
        ...
        <div class="hidden lg:flex lg:gap-x-12 text-gray-900 dark:text-white">
          <RouterLink to="/" class="text-sm font-semibold leading-6">Home</RouterLink>
          <RouterLink to="/about" class="text-sm font-semibold leading-6">About</RouterLink>
          <RouterLink to="/test" class="text-sm font-semibold leading-6">Test</RouterLink>
        </div>
        <div class="flex flex-1 items-center justify-end gap-x-6">
          <a
            href="#"
            class="hidden lg:block lg:text-sm lg:font-semibold lg:leading-6 lg:text-gray-900 lg:dark:text-white"
            >Log in</a
          >
          <a
            href="#"
